                ...
                <div className="container">
                    <div className="about-grid">
                        <div className="about-text">
                            <h2>Welcome to <span className="gradient-text">AllCloths</span></h2>
                            <p>
                                AllCloths was born from a deep love and respect for Indian traditional wear. We believe that
